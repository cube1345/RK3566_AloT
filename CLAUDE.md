...
**全局任务管理**：创建公共知识库 (public.md)→ 每次对cube的发言做出回应前，都要阅读本文档 → 执行完操作后，将当前的新状态更新到本   文档中。本文档主要内容不包括但不限于：总任务，实现路线，各步骤/组件的进度、目标、实现路线，我们的阻碍等等你认为完整描述项目细节的内容，能做到本文档能完整概括本话题的上下文。
